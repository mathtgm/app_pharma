...
class ProdutoCarrinho extends GetView<ProdutoCarrinhoController> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      controller.updateProdutoCarrinho();
                      Get.back();
                    },
                    child: Text(
                      controller.quantProduto.value == 0
                          ? 'Remover produto'
        ...
        children: [
          InkWell(
            ...
            onTap: () {
              ...
              controller.total.value =
                  controller.quantProduto.value * controller.precoUnid;
            },
            child: Container(
              height: 40,
              width: 45,
          ...
          Container(
            ...
            child: Center(
              child: Obx(
                () => Text(
                  controller.quantProduto.value.toString(),
                  textAlign: TextAlign.center,
                ),
              ),
            ),
          ...
          InkWell(
            ...
            highlightColor: Colors.transparent,
            onTap: () {
              controller.quantProduto > 0 ? controller.quantProduto -= 1 : null;
              controller.total.value = controller.quantProduto.value *
                  controller.precoUnid.toPrecision(2);
            },
            child: Container(
              height: 40,
              width: 45,
